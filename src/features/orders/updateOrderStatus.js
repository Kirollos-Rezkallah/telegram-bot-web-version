...
const statusCopy = {
  Новый: "Мы получили ваш заказ в магазина.",
  Подтвержден:
    "Заказ подтвержден. Мы зарезервировали для него производственное время.",
  "В работе":
    "Заказ уже в работе. Кондитерская команда приступила к приготовлению.",
