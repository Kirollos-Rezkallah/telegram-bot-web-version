...
export const seedProductsState = normalize([
  {
    ...
    description: 'Vanilla sponge, berry confit, mascarpone mousse, and white chocolate glaze.',
  ...
  },
  {
    ...
    description: 'Pistachio dacquoise, raspberry cremeux, and soft cream cheese frosting.',
    imageUrl: 'https://images.unsplash.com/photo-1464305795204-6f5bbfc7fb81?auto=format&fit=crop&w=640&q=80',
    basePrice: 7600,
  ...
  },
  {
    ...
    description: 'Thin honey layers, salted caramel cream, and roasted almond crumb.',
    imageUrl: 'https://images.unsplash.com/photo-1606890737304-57a1ca8a5b62?auto=format&fit=crop&w=640&q=80',
    basePrice: 5900,
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1606313564200-e75d5e30476c?auto=format&fit=crop&w=640&q=80',
    basePrice: 7200,
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?auto=format&fit=crop&w=640&q=80',
    basePrice: 4200,
    sizeOptions: ['24 pcs'],
    leadTimeHours: 24,
    isAvailable: true,
  ...
  },
  {
    ...
    description: 'Six mini desserts for sampling mousse, berry, chocolate, and caramel flavors.',
  ...
  },
  {
    ...
    description: 'Curated table with mini tarts, macarons, pavlovas, and cake shooters.',
    imageUrl: 'https://images.unsplash.com/photo-1519671482749-fd09be7ccebf?auto=format&fit=crop&w=640&q=80',
    basePrice: 24500,
  ...
  },
  {
    ...
    description: 'Vanilla or chocolate cupcakes with colored cream and themed toppers.',
    imageUrl: 'https://images.unsplash.com/photo-1486427944299-d1955d23e34d?auto=format&fit=crop&w=640&q=80',
    basePrice: 3900,
...
export const seedMessagesState = {
  ...
  entities: Object.fromEntries(seedMessages.map((message) => [message.id, message])),
...
export const seedBotSessionState = {
  ...
  suggestedProductIds: ['prod-berry-vanilla-mousse', 'prod-pistachio-raspberry', 'prod-honey-caramel'],
  draftOrder: {
    productId: null,
    quantity: null,
    pickupDate: '',
